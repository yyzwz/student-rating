        ...
        return {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    sortable: false,
                    render: (h, params) => {
                        if (params.row.achievementOne == 0) {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
                ...
                },
                {
                    ...
                    key: "achievementTwo",
                    render: (h, params) => {
                        if (params.row.achievementTwo == 0) {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
                ...
                },
                {
                    ...
                    sortable: false,
                    render: (h, params) => {
                        if (params.row.achievementThree == 0) {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
