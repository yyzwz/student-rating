...
CREATE DATABASE IF NOT EXISTS `property` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_croatian_ci */;
USE `property`;
...
INSERT INTO `authority` (`id`, `buttons`, `checked`, `expanded`, `icon_cls`, `leaf`, `menu_code`, `menu_config`, `menu_name`, `parent_id`, `sort_order`, `url`) VALUES
	...
	(104, 'Add,Edit,Delete,View,Export,Query', NULL, 1, ' ', 1, 'HouseManageInAllDepart', ' ', '通讯录管理', 70, 6003, 'houseManage.TelManagementInAll');
...
CREATE TABLE IF NOT EXISTS `role_authority` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3598 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `sys_user` (`id`, `email`, `last_logintime`, `password`, `real_name`, `role`, `tel`, `user_name`, `userGrade`) VALUES
	(1, '1176508722@qq.com', '2020-12-21 16:30:55', 'e10adc3949ba59abbe56e057f20f883e', '?????', 1, '10086', 'admin', '1?'),
...
-- 正在导出表  property.tel 的数据：~81 rows (大约)
DELETE FROM `tel`;
