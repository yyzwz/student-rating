...
public interface Service<E> {
	...
	public List<BaseParameter> creatNativeSqlQuery(String sql,BaseParameter param);//added by qmm


	public int check(Long[] ids, String checkOption, SysUser sysUser);//added by qmm
}
